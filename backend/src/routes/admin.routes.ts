...
adminRouter.get('/students', adminValidator, wrapRequestHandler(getStudentsController))
...
adminRouter.patch(
  ...
  adminValidator,
  editStudentValidator,
  filterMiddleware<EditStudentReqBody>(['avatar', 'dateOfAdmission', 'enrollNumber', 'name', 'email', 'phone']),
